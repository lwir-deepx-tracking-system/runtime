...
class DEEPXYoloV8PPUPostprocessor : public Postprocessor
{
private:
...
public:
    explicit DEEPXYoloV8PPUPostprocessor(std::string config_path);

    ~DEEPXYoloV8PPUPostprocessor() override = default;

...
class DEEPXYoloV8CPUPostprocessor : public Postprocessor
{
private:
...
public:
    explicit DEEPXYoloV8CPUPostprocessor(std::string config_path);

    ~DEEPXYoloV8CPUPostprocessor() override = default;
